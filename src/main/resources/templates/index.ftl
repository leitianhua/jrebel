...
<div class="container-fluid">
    <nav class="navbar navbar-light bg-light">
        <a class="navbar-brand" href="/">
            <img src="/tuzi.jpg" width="30" height="30" class="d-inline-block align-top" alt="Jrebel">
            Jrebel 在线激活
        </a>
    </nav>

    <div class="jumbotron" >
        <h2 class="display-5">Jrebel & Xrebel License Server!</h2>
        <p>JRebel 激活地址: <span style='color:red'><script>document.write(window.location.href)</script>${uuid}</span></p>
        <p>JRebel 激活邮箱：123456789@qq.com        </p>

        <p>
        <#list jrebel.social as s>
            <span><a href="${s.url}">${s.name}</a></span>&nbsp;&nbsp;<br/><br/>
        </#list>
        </p>


        <p>关注公众号【鲸蓝小】，发送关键字"jrebel"获取激活地址。  </p>
        <img src="/wechat.jpg" class="img-fluid rounded" style="max-width: 30%; max-height: 30%;"  alt="微信公众号">
...
<script>
    ...
    //             fetch('https://api.github.com/users/leitianhua/repos')
